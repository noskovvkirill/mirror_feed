    ...
    return (
        <Box
            ...
            {total && (
                <Box
                    layout='flexBoxRow'
                    css={{ width: 'calc($4 * 0.8)', boxShadow: '$outlineLarge', height: 'calc($4 * 0.8)', alignItems: 'center', justifyContent: 'center', overflow: 'hidden', backgroundColor: '$highlight', color: '$foregroundText', borderRadius: '$round' }}>
