            ...
            <StyledToast css={{
                ...
                <StyledBody>
                    ...
                    <StyledContent>
                        ...
                        This is WIP. Let us know if you have any suggestions.
    ...
    if (step === 2) {
        return (
            <StyledToast css={{
                ...
                <StyledBody>
                    <StyledHeader>
                        <Box as='h5' css={{ color: '$text' }}>Move around</Box>
                        <CloseButton onClick={() => { localStorage.setItem('mirror-feed-onboarding-state-new', "true"), setIsOnboarded(true) }}><Remove /></CloseButton>
                    </StyledHeader>
                    <StyledContent>
                        Remember the magical door in “Howl&apos;s Castle”? This menu works the same way. Use it to move around and explore new places. <br />

                        Press <StyledKey>ALT</StyledKey> or <StyledKey>⌥</StyledKey> to open it from anywhere. <br />You can also press <StyledKey>CMD+/</StyledKey> to open seach.
                    </StyledContent>
                    <StyledFooter>
                        <Button onClick={() => setStep(prevStep => prevStep -= 1)}>Prev</Button>
                        <Button onClick={() => {
