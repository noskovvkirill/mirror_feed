...
const OnboardingCuration = () => {
    ...
    return(
        ...
        color:'$foregroundTextBronze',
        border:'0px solid $foregroundBorder',boxSizing:'border-box', borderRadius:'$2', padding:'$4', margin:'0 0 $4 0'}}>
            ...
            <Box layout='flexBoxRow' css={{width:'100%',  justifyContent:'space-between'}}>
                <Box layout='flexBoxColumn' css={{alignItems:'flex-start'}}>
                    <p>There are 2 ways to add new items: </p>
                    <Box as='ul' css={{padding:'0 $2', margin:0}}>
                        <li>Bring new items here by dragging them from the Pinned List <StyledLabel><PinIcon/></StyledLabel> to the box below</li>
                ...
                <Box layout='flexBoxRow' css={{overflow:'hidden', color:'$foregroundBronze', alignItems:'flex-end', justifyContent:'flex-end', width:'20%', height:'auto'}}>
                    <Logo/>
                </Box>
            </Box>
